...
def bookings(request):
    ...
    if selected_date:
        ...
        return render(
            ...
            {"available_tables": results, "selected_date": selected_date},
        )
...
def bookings_now(request):
    ...
    if confirm:
        ...
        Bookings.objects.create(
            ...
            booking_start=ta.table_start,
            booking_end=ta.table_end,
            table=ta.table_no,
    ...
    return render(
        request,
        "bookings/bookings_now.html",
        {"ta": ta, "selected_date": selected_date},
    )
        ...
        for i, x in enumerate(range(0, 90)):
            ...
            for table in tables:
                for time_slot in time_slots:
                    TableAvail.objects.create(
                        table_no=table,
                        table_date=start_date,
                        table_start=time_slot[0],
                        table_end=time_slot[1],
                    )
