    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_status', models.CharField(choices=[('ACT', 'ACTIVE'), ('COMP', 'COMPLETE'), ('CANC', 'CANCEL BY US'), ('NOSHO', 'NO_SHOW')], default='Active', max_length=5)),
                ...
                ('table', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tables.tables')),
            ],
        ),
    ]
